...
-- INSERT INTO applications(id, name, content, status)
--     SELECT * FROM applications
--     WHERE NOT EXISTS (SELECT 1 FROM applications
--                              WHERE (id = '1' AND name = 'appName1' and content='appContent1' and status='CREATED') OR
--                                (id = '2' AND name = 'appName2' and content='appContent3' and status='VERIFIED'));
